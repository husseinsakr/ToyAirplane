...
class Experiment
{
   ...
   public static void main(String[] args) {
       ...
       int numCastingStationsSpitfire = 1;
       int numCastingStationsF16 = 1;
       int numCastingStationsConcorde = 1;
       int numCuttingGrindingStations = 20;
       int numCoatingStations = 20;
       int numInspectionPackagingStations = 20;
       int numMovers = 100;
